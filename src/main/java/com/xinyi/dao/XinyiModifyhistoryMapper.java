...
public interface XinyiModifyhistoryMapper {
     ...
     * This method corresponds to the database table xinyi_modifyhistory
     *
     ...
     * @mbg.generated Sat Jul 06 15:36:26 CST 2019
     */
    int updateByExampleSelective(@Param("record") XinyiModifyhistory record, @Param("example") XinyiModifyhistoryExample example);
     ...
     * @mbg.generated Sat Jul 06 15:36:26 CST 2019
     */
    int updateByExample(@Param("record") XinyiModifyhistory record, @Param("example") XinyiModifyhistoryExample example);
